...
function init_gear_sets()
    ...
    sets.precast.FC.Utsusemi = set_combine(sets.precast.FC, {feet="Hattori Kyahan +2"})
	
    -- Snapshot for ranged
    sets.precast.RA = {legs="Nahtirah Trousers"}
    -- Weaponskill sets
    -- Default set for any weaponskill that isn't any more specifically defined
    sets.precast.WS = {    ammo="Oshasha's Treatise",head="Hachiya Hatsuburi +3",body="Nyame Mail",hands="Nyame Gauntlets",legs="Mochizuki hakama +3",feet="Hattori Kyahan +2",
	...
	sets.precast.WS['Blade: Chi'].Full = {ammo="Seeth. Bomblet +1",head="Mochi. Hatsuburi +3",body={ name="Nyame Mail", augments={'Path: B',}},hands={ name="Nyame Gauntlets", augments={'Path: B',}},
		legs={ name="Nyame Flanchard", augments={'Path: B',}},feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",waist="Orpheus's Sash",left_ear="Moonshade Earring",right_ear="Hattori Earring +1",
	...
	sets.precast.WS['Blade: Chi'].WTF = {ammo="Seeth. Bomblet +1",head="Mochi. Hatsuburi +3",body={ name="Nyame Mail", augments={'Path: B',}},hands={ name="Nyame Gauntlets", augments={'Path: B',}},legs={ name="Nyame Flanchard", augments={'Path: B',}},
		feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",waist="Orpheus's Sash",left_ear="Moonshade Earring",right_ear="Hattori Earring +1",left_ring="Epaminondas's Ring",right_ring="Gere Ring",
	...
	sets.precast.WS['Blade: Hi'] = {ammo="Yetshila +1",head="Ken. Jinpachi +1",body="Ken. Samue +1",hands="Ryuo Tekko +1",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",
		waist="Gerdr Belt +1",left_ear="Odr Earring",right_ear="Lugra Earring +1",left_ring="Begrudging Ring",right_ring="Regal Ring",
		back={ name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: Hi'].SomeAcc = {ammo="Yetshila +1",head="Ken. Jinpachi +1",body="Ken. Samue +1",hands="Hattori Tekko +2",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",
    ...
    sets.precast.WS['Blade: Hi'].Full = {ammo="Yetshila +1",head="Hachiya Hatsu. +3",body="Ken. Samue +1",hands="Malignance Gloves",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",
	...
	sets.precast.WS['Blade: Hi'].WTF = {ammo="Yetshila +1",head="Hachiya Hatsu. +3",body="Malignance Tabard",hands="Malignance Gloves",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",waist="Gerdr Belt +1",
	...
	sets.precast.WS['Blade: Kamu'] = {ammo="Seeth. Bomblet +1",head="Adhemar Bonnet +1",body="Mpaca's Doublet",hands="Adhemar Wrist. +1",legs="Mpaca's Hose",feet="Hattori Kyahan +2",
	...
	sets.precast.WS['Blade: Kamu'].WTF = {ammo="Crepuscular Pebble",head="Ken. Jinpachi +1",body="Ken. Samue +1",hands="Malignance Gloves",legs="Tatena. Haidate +1",feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",
		waist="Sailfi Belt +1",left_ear="Lugra Earring +1",right_ear="Hattori Earring +1",left_ring="Epona's Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
	
    sets.precast.WS['Blade: Ku'] = {ammo="Seeth. Bomblet +1",head="Adhemar Bonnet +1",body="Agony Jerkin +1",hands="Mochizuki Tekko +3",legs="Tatena. Haidate +1",feet="Hattori Kyahan +2",neck="Fotia Gorget",
		waist="Fotia Belt",left_ear="Lugra Earring +1",right_ear="Mache Earring +1",left_ring="Regal Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: Ku'].SomeAcc = {ammo="Seeth. Bomblet +1",head="Adhemar Bonnet +1",body="Agony Jerkin +1",hands="Mochizuki Tekko +3",legs="Tatena. Haidate +1",feet="Hattori Kyahan +2",neck="Fotia Gorget",
		waist="Fotia Belt",left_ear="Lugra Earring +1",right_ear="Mache Earring +1",left_ring="Regal Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: Ku'].Full =  {ammo="Crepuscular Pebble",head="Hachiya Hatsu. +3",body="Malignance Tabard",hands="Malignance Gloves",legs="Samnuha Tights",feet="Hattori Kyahan +2",
	...
	sets.precast.WS['Blade: Ku'].WTF = {ammo="Crepuscular Pebble",head="Ken. Jinpachi +1",body="Malignance Tabard",hands="Malignance Gloves",legs="Tatena. Haidate +1",feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",
		waist="Fotia Belt",left_ear="Lugra Earring +1",right_ear="Hattori Earring +1",left_ring="Sroda Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
	
	sets.precast.WS['Blade: Metsu'] = {ammo="Aurgelmir Orb +1",head="Hachiya Hatsu. +3",body="Agony Jerkin +1",hands="Hattori Tekko +2",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",
		...
		back={ name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: Metsu'].SomeAcc = {ammo="Aurgelmir Orb +1",head="Hachiya Hatsu. +3",body="Agony Jerkin +1",hands="Hattori Tekko +2",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",
		neck="Ninja Nodowa +2",waist="Sailfi Belt +1",left_ear="Lugra Earring +1",right_ear="Mache Earring +1",left_ring="Regal Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: Metsu'].Full =  {ammo="Crepuscular Pebble",head="Hachiya Hatsu. +3",body="Malignance Tabard",hands="Malignance Gloves",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",
	...
	sets.precast.WS['Blade: Metsu'].WTF = {ammo="Crepuscular Pebble",head="Hachiya Hatsu. +3",body="Malignance Tabard",hands="Malignance Gloves",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",
	...
	sets.precast.WS['Blade: Retsu'] = {ammo="Seeth. Bomblet +1",head="Adhemar Bonnet +1",body="Mpaca's Doublet",hands="Adhemar Wrist. +1",legs="Tatena. Haidate +1",feet="Hattori Kyahan +2",neck="Fotia Gorget",
		waist="Sailfi Belt +1",left_ear="Lugra Earring +1",right_ear="Mache Earring +1",left_ring="Regal Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: Retsu'].SomeAcc = {ammo="Seeth. Bomblet +1",head="Adhemar Bonnet +1",body="Mpaca's Doublet",hands="Adhemar Wrist. +1",legs="Tatena. Haidate +1",feet="Hattori Kyahan +2",neck="Rep. Plat. Medal",
		waist="Sailfi Belt +1",left_ear="Lugra Earring +1",right_ear="Mache Earring +1",left_ring="Regal Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%',}}}
	...
	sets.precast.WS['Blade: Retsu'].WTF = {ammo="Crepuscular Pebble",head="Ken. Jinpachi +1",body="Malignance Tabard",hands="Malignance Gloves",legs="Samnuha Tights",feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",
		waist="Sailfi Belt +1",left_ear="Lugra Earring +1",right_ear="Hattori Earring +1",left_ring="Epona's Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%',}}}
    ...
    sets.precast.WS['Blade: Shun'] = {ammo="Aurgelmir Orb +1",head="Ken. Jinpachi +1",body={ name="Adhemar Jacket +1", augments={'DEX+12','AGI+12','Accuracy+20',}},hands="Adhemar Wrist. +1",legs="Tatena. Haidate +1",
		feet="Hattori Kyahan +2",neck="Fotia Gorget",waist="Fotia Belt",left_ear="Lugra Earring +1",right_ear="Hattori Earring +1",left_ring="Regal Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: Shun'].SomeAcc = {ammo="Aurgelmir Orb +1",head="Mpaca's Cap",body="Malignance Tabard",hands="Malignance Gloves",legs="Samnuha Tights",feet="Hattori Kyahan +2",neck="Fotia Gorget",waist="Fotia Belt",
    ...
    sets.precast.WS['Blade: Teki'] = {ammo="Seeth. Bomblet +1",head="Mochi. Hatsuburi +3",body={ name="Nyame Mail", augments={'Path: B',}},hands={ name="Nyame Gauntlets", augments={'Path: B',}},legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",
		...
		back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: Teki'].SomeAcc = {ammo="Seeth. Bomblet +1",head="Mochi. Hatsuburi +3",body={ name="Nyame Mail", augments={'Path: B',}},hands={ name="Nyame Gauntlets", augments={'Path: B',}},legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",
		neck="Fotia Gorget",waist="Orpheus's Sash",left_ear="Moonshade Earring",right_ear="Lugra Earring +1",left_ring="Epaminondas's Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: Teki'].Full =  {ammo="Seeth. Bomblet +1",head="Mochi. Hatsuburi +3",body="Gyve Doublet",hands={ name="Nyame Gauntlets", augments={'Path: B',}},legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",
    ...
    sets.precast.WS['Blade: Ten'] = {ammo="Seeth. Bomblet +1",head="Hachiya Hatsu. +3",body="Agony Jerkin +1",hands={ name="Nyame Gauntlets", augments={'Path: B',}},legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Rep. Plat. Medal",
		...
		back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: Ten'].SomeAcc = {ammo="Seeth. Bomblet +1",head="Hachiya Hatsu. +3",body="Agony Jerkin +1",hands="Mochizuki Tekko +3",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Rep. Plat. Medal",
		waist="Sailfi Belt +1",left_ear="Lugra Earring +1",right_ear="Ishvara Earring",left_ring="Epaminondas's Ring",right_ring="Regal Ring",
		back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: Ten'].Full =  {ammo="Crepuscular Pebble",head="Hachiya Hatsu. +3",body="Malignance Tabard",hands="Malignance Gloves",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",
	...
	sets.precast.WS['Blade: Ten'].WTF = {ammo="Crepuscular Pebble",head="Hachiya Hatsu. +3",body="Malignance Tabard",hands="Malignance Gloves",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",
		waist="Sailfi Belt +1",left_ear="Lugra Earring +1",right_ear="Hattori Earring +1",left_ring="Epaminondas's Ring",right_ring="Sroda Ring",
		back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
	...
	sets.precast.WS['Blade: To'] = {ammo="Seeth. Bomblet +1",head="Mochi. Hatsuburi +3",body={ name="Nyame Mail", augments={'Path: B',}},hands={ name="Nyame Gauntlets", augments={'Path: B',}},legs="Mochi. Hakama +3",
		feet="Hattori Kyahan +2",neck="Fotia Gorget",waist="Orpheus's Sash",left_ear="Lugra Earring +1",right_ear="Moonshade Earring",left_ring="Epaminondas's Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: To'].SomeAcc = {ammo="Seeth. Bomblet +1",head="Mochi. Hatsuburi +3",body={ name="Nyame Mail", augments={'Path: B',}},hands={ name="Nyame Gauntlets", augments={'Path: B',}},legs="Mochi. Hakama +3",
		feet="Hattori Kyahan +2",neck="Fotia Gorget",waist="Orpheus's Sash",left_ear="Lugra Earring +1",right_ear="Moonshade Earring",left_ring="Epona's Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
    sets.precast.WS['Blade: To'].Full =  {ammo="Seeth. Bomblet +1",head="Mochi. Hatsuburi +3",body="Gyve Doublet",hands={ name="Nyame Gauntlets", augments={'Path: B',}},legs={ name="Nyame Flanchard", augments={'Path: B',}},
		feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",waist="Orpheus's Sash",left_ear="Moonshade Earring",right_ear="Hattori Earring +1",left_ring="Epona's Ring",right_ring="Gere Ring",
		back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
	...
	sets.precast.WS['Savage Blade'] = {ammo="Seeth. Bomblet +1",head={ name="Nyame Helm", augments={'Path: B',}},body="Agony Jerkin +1",hands="Mochizuki Tekko +3",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Rep. Plat. Medal",
	...
	sets.precast.WS['Savage Blade'].someAcc = {ammo="Seeth. Bomblet +1",head={ name="Nyame Helm", augments={'Path: B',}},body="Agony Jerkin +1",hands="Mochizuki Tekko +3",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Rep. Plat. Medal",
		waist="Sailfi Belt +1",left_ear="Lugra Earring +1",right_ear="Moonshade Earring",left_ring="Regal Ring",right_ring="Gere Ring",back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
	sets.precast.WS['Savage Blade'].Full = {ammo="Crepuscular Pebble",head="Hachiya Hatsu. +3",body="Malignance Tabard",hands="Malignance Gloves",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",waist="Sailfi Belt +1",
	...
	sets.precast.WS['Savage Blade'].WTF = {ammo="Seeth. Bomblet +1",head="Hachiya Hatsu. +3",body="Hattori Ningi +2",hands="Malignance Gloves",legs="Mochi. Hakama +3",feet="Hattori Kyahan +2",neck="Ninja Nodowa +2",waist="Sailfi Belt +1",
    ...
    left_ring="Defending Ring",right_ring="Archon Ring",back="Moonbeam Cape",}
    ...
    sets.engaged = {ammo="Date Shuriken",head="Ryuo Somen +1",body="Malignance Tabard",hands="Malignance Gloves",legs="Mochi. Hakama +3",feet="Tatena. Sune. +1",neck="Ninja Nodowa +2",
		waist="Reiki Yotai",left_ear="Suppanomimi",right_ear="Dedition Earring",left_ring="Defending Ring",right_ring="Gelatinous Ring +1",back={ name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Store TP"+10','Damage taken-5%',}}}
	...
	sets.engaged.WTF = {ammo="Date Shuriken",head="Malignance Chapeau",body="Hattori Ningi +2",hands="Malignance Gloves",legs="Mpaca's Hose",feet="Malignance Boots",neck="Ninja Nodowa +2",waist="Windbuffet Belt +1",
